...
const CalendarPage: React.FC = () => {
    ...
    useEffect(() => {
        ...
        timesheets.forEach(({ date, status, note, studentsId }) => {
            ...
            <div className={styles.events}>
                {listData.map((item, index) => {
                    const event = timesheets.find((t) => {
                        const student = students.find(s => s.id === t.studentsId);
                        const studentName = student ? `${student.firstName} ${student.lastName}` : "Unknown Student";
        ...
        <>
            ...
            >
                <Form form={form} layout="vertical">
                    <Form.Item name="studentsId" label="Sinh viên" rules={[{ required: true, message: "Chọn sinh viên" }]}>
                        <Select>
