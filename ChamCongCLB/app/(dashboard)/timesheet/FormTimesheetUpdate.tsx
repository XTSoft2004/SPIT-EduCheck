...
export default function FormTimesheetUpdate({
  form,
  classes,
  students,
}: FormClassProps) {
  ...
  return (
    <Form form={form} layout="vertical">
      ...
      <Form.Item
        ...
        name="studentsId"
        rules={[
          { required: true, message: 'Vui lòng chọn danh sách sinh viên' },
        ]}
      >
        <Select
          showSearch
      ...
      <Form.Item
        ...
        rules={[
          {
            required: !form.getFieldValue('imageBase64'),
            message: 'Vui lòng chọn hình ảnh điểm danh',
          },
        ]}
      >
