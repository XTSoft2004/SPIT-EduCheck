  ...
  const columns = [
    ...
    },
    {
      ...
      render: (lecturersId: number[]) => {
        ...
        return lecturerNames.length > 30
          ? `${lecturerNames.slice(0, 30)}...`
          : lecturerNames
      },
    },
    {
    ...
    },
    {
      ...
      render: (studentsId: number[]) => {
        ...
        return studentNames.length > 30
          ? `${studentNames.slice(0, 30)}...`
          : studentNames
      },
    },
    ...(role === Role.ADMIN
      ...
      <CustomModal
        ...
        footer={
          <Space>
            <Button
              type="primary"
              onClick={() => selectedClass && handleUpdate(selectedClass)}
            >
              Cập nhật
            </Button>
            <Button type="default" onClick={handleClose}>
