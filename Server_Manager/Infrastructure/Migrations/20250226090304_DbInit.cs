        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Image_Check = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { -2L, "System", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "User", null, new DateTime(2025, 2, 26, 16, 3, 4, 444, DateTimeKind.Local).AddTicks(2571) },
                    { -1L, "System", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Admin", null, new DateTime(2025, 2, 26, 16, 3, 4, 442, DateTimeKind.Local).AddTicks(6509) }
                });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "CreatedBy", "CreatedDate", "IsLocked", "IsVerify", "ModifiedBy", "ModifiedDate", "Password", "RoleId", "StudentId", "Username" },
                values: new object[] { -1L, "System", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), false, false, null, new DateTime(2025, 2, 26, 16, 3, 4, 444, DateTimeKind.Local).AddTicks(9286), "admin", -1L, null, "admin" });
